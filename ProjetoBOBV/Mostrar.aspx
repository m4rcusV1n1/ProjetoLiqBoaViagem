<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="Mostrar.aspx.cs" Inherits="ProjetoBOBV.Mostrar" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="Label21" runat="server" Text="Data Contato"></asp:Label>
        <br />
              <asp:TextBox ID="txtdtcontato" runat="server" CssClass="form-control" TextMode="date" required="required"></asp:TextBox>
...
<div class="col-md-2">
    ...
    <asp:Label ID="Label27" runat="server" Text="Mensalidades do Produto"></asp:Label>
        <br />
       <asp:TextBox ID="txtmensalidade" runat="server" CssClass="form-control" TextMode="number"></asp:TextBox>         
    </div>
       <div class="col-md-2">
    <asp:Label ID="Label28" runat="server" Text="Data da Venda"></asp:Label>
        <br />
       <asp:TextBox ID="txtdatavenda" runat="server" CssClass="form-control" TextMode="date" ></asp:TextBox>         
    </div>    
        </div>
        <div class="row">
<div class="col-md-3">
...
<div class="col-md-3">
    ...
    <br />
     <asp:TextBox ID="txtdataagendamento" runat="server" CssClass="form-control" TextMode="Date" ></asp:TextBox>         
    </div>
<div class="col-md-3">
...
<asp:Label ID="Label19" runat="server" Text="Observação"></asp:Label>
        ...
        <br />
        <asp:TextBox ID="txtob" runat="server" CssClass="form-control" TextMode="MultiLine" required="required"></asp:TextBox>
        <!-- fim div container -->
